...
class HuaweiModule(BaseModule):
    @property
    def name(self): return "Huawei"
    @property
    ...
    def create_ui(self, parent=None):
        ...
        btn = QPushButton("Huawei Tools (Placeholder)")
        btn.clicked.connect(lambda: self.log_message("Huawei module - coming soon"))
